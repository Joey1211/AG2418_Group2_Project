...
if opt.multi:
    ...
    dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=opt.batchsize,
                                             shuffle=False, num_workers=0) for x in ['gallery_satellite', 'gallery_drone','gallery_street', 'query_satellite', 'query_drone', 'query_street']}
...
if __name__ == "__main__":
    ...
    scipy.io.savemat('pytorch_result_streettodrone.mat',result)
